		...
		<div class=principal>
			...
			<div class=section>
				...
				include("conectar.php");
					$query = "select * from produto WHERE modelo='arma de pressao' AND tipo='Carabinas'";
					...
					while($result = mysql_fetch_assoc($resultQuery)){
						...
						if(utf8_encode($result['foto']) != ""){
							...
							echo "
							<div class=divproduto title=Carabinas ID=Carabinas>
					...
					$query = "select * from produto WHERE modelo='arma de pressao' AND tipo='Gas Ram'";
					$resultQuery = mysql_query($query);
					...
					while($result = mysql_fetch_assoc($resultQuery)){
						...
						if(utf8_encode($result['foto']) != ""){
							...
							echo "
							<div class=divproduto title='Gas Ram' ID='Gas Ram'>
								<div class=produtoimg>
									<img src='assets/imagens/produto/$resultBanco[6]' class=cemporcento>
								</div>
								<div class=produtodesc>
					...
					$query = "select * from produto WHERE modelo='arma de pressao' AND tipo='Mola'";
					$resultQuery = mysql_query($query);
					...
					while($result = mysql_fetch_assoc($resultQuery)){
						...
						if(utf8_encode($result['foto']) != ""){
							...
							echo "
							<div class=divproduto title=Mola ID=Mola>
								<div class=produtoimg>
									<img src='assets/imagens/produto/$resultBanco[6]' class=cemporcento>
								</div>
								<div class=produtodesc>
					...
					$query = "select * from produto WHERE modelo='arma de pressao' AND tipo='Multipmp'";
					$resultQuery = mysql_query($query);
					...
					while($result = mysql_fetch_assoc($resultQuery)){
						...
						if(utf8_encode($result['foto']) != ""){
							...
							echo "
							<div class=divproduto title=Multipmp ID=Multipmp>
								<div class=produtoimg>
									<img src='assets/imagens/produto/$resultBanco[6]' class=cemporcento>
								</div>
								<div class=produtodesc>
					...
					$query = "select * from produto WHERE modelo='arma de pressao' AND tipo='PCP'";
					$resultQuery = mysql_query($query);
					...
					while($result = mysql_fetch_assoc($resultQuery)){
						...
						if(utf8_encode($result['foto']) != ""){
							...
							echo "
							<div class=divproduto title=PCP ID=PCP>
								<div class=produtoimg>
									<img src='assets/imagens/produto/$resultBanco[6]' class=cemporcento>
								</div>
								<div class=produtodesc>
					...
					$query = "select * from produto WHERE modelo='arma de pressao' AND tipo='Pistola'";
					$resultQuery = mysql_query($query);
